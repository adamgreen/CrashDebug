...
TEST_GROUP_BASE(CrashCatcherHexDump, CrashCatcherBaseTest)
{
    void setup()
    {
...
TEST(CrashCatcherHexDump, FileTooShortForFlags_ShouldThrowFileFormatException)
{
...
TEST(CrashCatcherHexDump, DumpContainingFloatRegistersToo_VerifyRegistersReadAndEmptyMemoryRegions)
{
...
TEST(CrashCatcherHexDump, FileTooShortForFloatRegisters_ShouldThrowFileFormatException)
{
    DumpFPFileTop fileData;
